...
accesspoints                = ["cs-vct", "dbr-vct", "cs-shared-logs", "dbr-shared-logs", "da", "d2-extension","d2classic-vct", "d2config-vct", "d2rest-vct", "d2smartview-vct", "dctm-workflow-designer", "records", "rqm", "d2classic-shared-logs", "d2config-shared-logs", "d2rest-shared-logs", "d2smartview-shared-logs", "dcc", "dtr", "xplore", "ijms"]
